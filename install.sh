...
# you can untar https://mirrors.ustc.edu.cn/Homebrew/brew/tarball/master
# anywhere you like.
...
REQUIRED_RUBY_VERSION=2.6    # https://mirrors.ustc.edu.cn/Homebrew/brew/pull/6556
...
Your Mac OS X version is too old. See:
  ${tty_underline}https://mirrors.ustc.edu.cn/mistydemeo/tigerbrew${tty_reset}
EOABORT
    )"
...
# https://mirrors.ustc.edu.cn/Homebrew/brew/blob/master/Library/Homebrew/keg.rb
directories=(
...
echo "$(
  cat <<EOS
  ${tty_underline}https://mirrors.ustc.edu.cn/Homebrew/brew#donations${tty_reset}
EOS
)
"
